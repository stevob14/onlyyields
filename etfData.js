const etfData = [
    ...
    },
    {
        ...
        distributionFrequency: "Monthly",
        website: "https://www.kurvinvest.com/etf/aapx/"
    },
    {
        ticker: "TSLP",
    ...
    {
        ticker: "MSTP",
        name: "Kurv Yield Premium Strategy MicroStrategy (MSTR) ETF",
        issuer: "Kurv",
        exposure: "Individual Stock (MSTR)",
        goal: "Income/Exposure",
        strategy: "Seeks to provide current income while maintaining the opportunity for exposure to the share price of MicroStrategy Inc., subject to a limit on potential investment gains.",
        distributionFrequency: "Monthly",
        website: "https://www.kurvinvest.com/etf/mstp/"
    },
    {
        ticker: "NVDP",
        name: "Kurv Yield Premium Strategy NVIDIA (NVDA) ETF",
        issuer: "Kurv",
        exposure: "Individual Stock (NVDA)",
        goal: "Income/Exposure",
        strategy: "Seeks to provide current income while maintaining the opportunity for exposure to the share price of NVIDIA Corp., subject to a limit on potential investment gains.",
        distributionFrequency: "Monthly",
        website: "https://www.kurvinvest.com/etf/nvdp/"
    },
    {
        ticker: "AMZP",
